        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 col-md-4 mb-3">
                    ...
                    <select name="race_id" id="race_id" class="form-select mb-2">
                        <option value="null">Selecciona una raza</option>
                    </select>

                    <label for="subrace_id" class="form-label">Subraza</label>
                    <select name="subrace_id" id="subrace_id" class="form-select"></select>
                </div>

                <div class="col-sm-12 col-md-4 mb-3">
                    <label for="clase_id" class="form-label">Clase</label>
                    <select name="clase_id" id="clase_id" class="form-select mb-2">
                        <option value="null">Selecciona una clase</option>
                    </select>

                    <label for="subclase_id" class="form-label">Subclase</label>
                    <select name="subclase_id" id="subclase_id" class="form-select"></select>
                </div>

                <div class="col-sm-12 col-md-4 mb-3">
                    <label for="background_id" class="form-label">Transfondo</label>
                    <select name="background_id" id="background_id" class="form-select">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-2">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex align-items-center">
                                ...
                                <label for="SalvFUE" class="ms-2">Competencia en salvación de fuerza</label>
                            </div>
                            <div class="col-12 d-flex align-items-center">
                                <input type="checkbox" name="CompAtletismo" id="CompAtletismo" value="1" {{ old('CompAtletismo') ? 'checked' : '' }}>
                                <label for="CompAtletismo" class="ms-2">Competencia en Atletismo</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-2">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex align-items-center">
                                ...
                                <label for="SalvDES" class="ms-2">Competencia en salvación de destreza</label>
                            </div>
                            <div class="col-12 d-flex align-items-center">
                                <input type="checkbox" name="CompAcrobacias" id="CompAcrobacias" value="1" {{ old('CompAcrobacias') ? 'checked' : '' }}>
                                <label for="CompAcrobacias" class="ms-2">Competencia en Acrobacias</label>
                            </div>
                            <div class="col-12 d-flex align-items-center">
                                <input type="checkbox" name="CompJuegoManos" id="CompJuegoManos" value="1" {{ old('CompJuegoManos') ? 'checked' : '' }}>
                                <label for="CompJuegoManos" class="ms-2">Competencia en Juego de manos</label>
                            </div>
                            <div class="col-12 d-flex align-items-center">
                                <input type="checkbox" name="CompSigilo" id="CompSigilo" value="1" {{ old('CompSigilo') ? 'checked' : '' }}>
                                <label for="CompSigilo" class="ms-2">Competencia en Sigilo</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-2">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex align-items-center">
                                ...
                                <label for="SalvCON" class="ms-2">Competencia en salvación de constitución</label>
                            </div>
                        </div>
                    </div>
